# YOLOv11 cotton disease detection system

## Body

YOLOv11 Cotton Disease Detection System based on Deep Learning YOLOv11: A cotton leaf disease detection system (YOLOv11+YOLO dataset + UI interface + login and registration interface + Python project source code + model)

nc: 6 classes,
Names: ['blight', 'curl', 'grey mildew', 'healthy', 'leaf spot', 'wilt'],
Dataset quantity: training set 3708 images, validation set 232 images, test set 233 images.
